...
public class SignatureCustody extends AnnexCustody {
    ...
    public static final String[] ALL_TYPES_OF_SIGNATURES = { CADES_SIGNATURE, XADES_SIGNATURE, SMIME_SIGNATURE,
            PADES_SIGNATURE, OOXML_SIGNATURE, ODF_SIGNATURE, OTHER_DOCUMENT_WITH_ATTACHED_SIGNATURE,
            OTHER_SIGNATURE_WITH_ATTACHED_DOCUMENT, OTHER_SIGNATURE_WITH_DETACHED_DOCUMENT };
    ...
    public SignatureCustody(String name, byte[] data, String signatureType, Boolean attachedDocument) {
        this(name, null, data, signatureType, null);
    }
    ...
    public SignatureCustody(String name, long length, String signatureType, Boolean attachedDocument) {
        this(name, null, length, signatureType, null);
    }
     ...
     */
    public SignatureCustody(String name, String mime, byte[] data, String signatureType, Boolean attachedDocument) {
        super(name, mime, data);
        this.signatureType = signatureType;
        this.attachedDocument = attachedDocument;
    }

    public SignatureCustody(String name, String mime, long length, String signatureType, Boolean attachedDocument) {
