 ...
 * 
 */
public interface IDocumentCustodyPlugin extends IPluginIB {

    public static final String DOCUMENTCUSTODY_BASE_PROPERTY = IPLUGINSIB_BASE_PROPERTIES + "documentcustody.";
     ...
     * @throws Exception
     */
    String getOriginalFileUrl(String custodyID, Map<String, Object> parameters) throws CustodyException;
     ...
     * @throws Exception
     */
    String getPrintableFileUrl(String custodyID, Map<String, Object> parameters) throws CustodyException;
     ...
     * @throws Exception
     */
    String getEniFileUrl(String custodyID, Map<String, Object> parameters) throws CustodyException;
     ...
     */
    String getValidationFileUrl(String custodyID, Map<String, Object> parameters) throws CustodyException;
     ...
     */
    @Deprecated
    void saveSignature(String custodyID, Map<String, Object> parameters, SignatureCustody signatureCustody)
            throws CustodyException, NotSupportedCustodyException;
