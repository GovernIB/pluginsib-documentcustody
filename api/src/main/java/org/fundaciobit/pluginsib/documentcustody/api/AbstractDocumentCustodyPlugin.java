package org.fundaciobit.pluginsib.documentcustody.api;
 ...
 * deleteFile(String custodyID, String ... relativePaths); - existsFile(String custodyID,
 * String relativePath); - writeFile(String custodyID, String relativePath, byte[] data) throws
 * Exception; - byte[] readFile(String custodyID, String relativePath) throws Exception; - long
 * lengthFile(String custodyID, String relativePath) throws Exception; - String
 * getPropertyBase();
 *
 * @author anadal
 *
 */
public abstract class AbstractDocumentCustodyPlugin extends AbstractPluginProperties implements IDocumentCustodyPlugin {
    ...
    public static final String ABSTRACT_CSV = "csv_expressionlanguage";
    ...
    private final String getCustodyDocumentName(String custodyID, Map<String, Object> custodyParameters)
            throws CustodyException {
        return CUSTODY_PREFIX_AND_FOLDER(custodyParameters) + custodyID + ".DOC";
    }

    private final String getCustodyDocumentInfoName(String custodyID, Map<String, Object> custodyParameters)
            throws CustodyException {
        return CUSTODY_PREFIX_AND_FOLDER(custodyParameters) + custodyID + ".DOCINFO";
    }

    private final String getCustodySignatureName(String custodyID, Map<String, Object> custodyParameters)
            throws CustodyException {
        return CUSTODY_PREFIX_AND_FOLDER(custodyParameters) + custodyID + ".SIGN";
    }

    private final String getCustodySignatureInfoName(String custodyID, Map<String, Object> custodyParameters)
            throws CustodyException {
        return CUSTODY_PREFIX_AND_FOLDER(custodyParameters) + custodyID + ".SIGNINFO";
    }

    private final String getCustodyAnnexName(String annexID, Map<String, Object> custodyParameters)
            throws CustodyException {
        return CUSTODY_PREFIX_AND_FOLDER(custodyParameters) + annexID + ".ANNEX";
    }

    private final String getCustodyAnnexInfoName(String annexID, Map<String, Object> custodyParameters)
            throws CustodyException {
        return CUSTODY_PREFIX_AND_FOLDER(custodyParameters) + annexID + ".ANNEXINFO";
    }

    private final String getCustodyMetadataInfoName(String custodyID, Map<String, Object> custodyParameters)
            throws CustodyException {
    ...
    public String reserveCustodyID(Map<String, Object> custodyParameters) throws CustodyException {
        ...
        if (baseUrl != null && baseUrl.indexOf("{2}") != -1) {
            ...
            try {
                ...
                // System.out.println(" Guardant fitxer(" +
                // hashes.getAbsolutePath() + ");");
    ...
    public boolean supportsDeleteCustody() {
        return this.supportsDeleteDocument() && this.supportsDeleteSignature() && this.supportsDeleteAnnex()
    ...
    public void deleteCustody(String custodyID) throws CustodyException, NotSupportedCustodyException {
        ...
        // Per ara no podem esborrar ja que no se si hi ha altres documents al
        // mateix directori
        // Fins i tot pot existir el document electrònic però que no tengui cap
        // arxiu relacionat.
        ...
        if (folder == null || folder.trim().length() == 0) {
            ...
            try {
                ...
                log.warn("Error desconegur esborrant fitxer amb path=" + path + "(custodyID=" + custodyID + ")");
            }
        }
    }
    ...
    public String getOriginalFileUrl(String custodyID, Map<String, Object> parameters) throws CustodyException {
        ...
        return getValidationUrlStatic(custodyID, csv, parameters, baseUrl, baseUrlEL, hashAlgorithm, hashPassword,
                "validationUrl_", log);
    ...
    public String getPrintableFileUrl(String custodyID, Map<String, Object> parameters) throws CustodyException {
        ...
        return getValidationUrlStatic(custodyID, csv, parameters, null, baseUrlEL, hashAlgorithm, hashPassword, log);
    ...
    @Override
    public String getCsv(String custodyID, Map<String, Object> parameters) throws CustodyException {
        ...
        return getValidationUrlStatic(custodyID, null, parameters, null, csvEL, hashAlgorithm, hashPassword, log);
    ...
    public String getCsvGenerationDefinition(String custodyID, Map<String, Object> parameters) throws CustodyException {
        ...
        String csvGenerationDefinitionEL = getProperty(getPropertyBase() + ABSTRACT_CSV_GENERATION_DEFINITION);
    ...
    public static String getValidationUrlStatic(String custodyID, String csv, Map<String, Object> parameters,
            String baseUrl, String baseUrlEL, String hashAlgorithm, String hashPassword, Logger log)
            throws CustodyException {
    ...
    public static String getValidationUrlStatic(String custodyID, String csv, Map<String, Object> parameters,
            String baseUrl, String baseUrlEL, String hashAlgorithm, String hashPassword, String prefix, Logger log)
            throws CustodyException {
        // {0} => custodyID
    ...
    public static String processExpressionLanguage(String plantilla, Map<String, Object> custodyParameters)
            throws CustodyException {
        return processExpressionLanguage(plantilla, custodyParameters, null);
    }

    public static String processExpressionLanguage(String plantilla, Map<String, Object> custodyParameters,
            Locale locale) throws CustodyException {
        try {
     ...
     */
    @Override
    public void saveAll(String custodyID, Map<String, Object> custodyParameters, DocumentCustody document,
            SignatureCustody signature, Metadata[] metadata)
    ...
    public void deleteDocument(String custodyID) throws CustodyException, NotSupportedCustodyException {
        deleteFile(custodyID, getCustodyDocumentName2(custodyID), getCustodyDocumentInfoName2(custodyID));
    ...
    @Override
    @Deprecated
    public void saveSignature(String custodyID, Map<String, Object> custodyParameters, SignatureCustody document)
            throws CustodyException {
    ...
    /**
     * @return true if system automaically refresh signature o document with signature to not
     *         loss validate of signature. false otherwise. Null unknown
     */
    @Override
     ...
     */
    @Override
    public synchronized String addAnnex(String custodyID, AnnexCustody annex, Map<String, Object> custodyParameters)
            throws CustodyException, NotSupportedCustodyException {
     ...
     * @throws CustodyException
     */
    protected List<Metadata> updateAutomaticMetadatas(String custodyID, Map<String, Object> custodyParameters,
            boolean ignoreErrors) throws CustodyException {

        if (supportsMetadata()) {
            final String propertyBase = getPropertyBase();

            List<Metadata> list = recollectAutomaticMetadatas(this, custodyParameters, propertyBase, ignoreErrors);
     ...
     * @throws CustodyException
     */
    public static List<Metadata> recollectAutomaticMetadatas(AbstractPluginProperties pluginProperties,
            Map<String, Object> custodyParameters, String propertyBase, boolean ignoreErrors) throws CustodyException {
            ...
            for (int i = 0; i < items.length; i++) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!ignoreErrors) {
                            throw new CustodyException("AutmaticMetadatas::Error processant el valor de " + valueEL
                                    + "(item = " + item + ")");
                        }
                    }
                    ...
                    if (!ignoreErrors) {
                        final String msg = "Error intentant obtenir el nom de la metadada " + metadata
                                + " o el seu valor: " + e.getMessage();
                        throw new CustodyException(msg, e);
                    }
                }
            }
    ...
    @Override
    public void addMetadata(String custodyID, Metadata metadata, Map<String, Object> custodyParameters)
            throws CustodyException, NotSupportedCustodyException, MetadataFormatException {
    ...
    @Override
    public void addMetadata(String custodyID, Metadata[] metadatas, Map<String, Object> custodyParameters)
            throws CustodyException, NotSupportedCustodyException, MetadataFormatException {
    ...
    @Override
    public void updateMetadata(String custodyID, Metadata metadata, Map<String, Object> custodyParameters)
            throws CustodyException, NotSupportedCustodyException, MetadataFormatException {
    ...
    @Override
    public List<Metadata> deleteMetadata(String custodyID, String[] keys) throws CustodyException {
        // TODO OPTIMITZAR
    ...
    public Map<String, List<Metadata>> getAllMetadata(String custodyID)
            throws NotSupportedCustodyException, CustodyException {
    ...
    protected AnnexCustody getDocOrSign(String custodyID, String docPath, String infoPath) throws CustodyException {
        try {
            ...
            final String msg = "Error intentant obtenir el document custodia amb ID = " + custodyID + " en el path "
                    + docPath + " (" + infoPath + ")";
            log.error(msg, ex);
            throw new CustodyException(msg, ex);
        }
    ...
    protected void checkSize(String custodyID, AnnexCustody dc, String infoPath, String filePath)
            throws CustodyException {
    ...
    protected AnnexCustody getDocOrSignOnlyInfo(String custodyID, String infoPath) throws CustodyException {
    ...
    protected Object readObject(String custodyID, String relativePath) throws CustodyException {
        try {
            ...
            dataStr = dataStr.replace("class=\"org.fundaciobit.plugins.documentcustody.AnnexCustody\"",
                    "class=\"org.fundaciobit.plugins.documentcustody.api.AnnexCustody\"");
            dataStr = dataStr.replace("class=\"org.fundaciobit.plugins.documentcustody.DocumentCustody\"",
                    "class=\"org.fundaciobit.plugins.documentcustody.api.DocumentCustody\"");
            dataStr = dataStr.replace("class=\"org.fundaciobit.plugins.documentcustody.SignatureCustody\"",
                    "class=\"org.fundaciobit.plugins.documentcustody.api.SignatureCustody\"");

            dataStr = dataStr.replace("class=\"org.fundaciobit.plugins.documentcustody.api.AnnexCustody\"",
                    "class=\"org.fundaciobit.pluginsib.documentcustody.api.AnnexCustody\"");
            dataStr = dataStr.replace("class=\"org.fundaciobit.plugins.documentcustody.api.DocumentCustody\"",
    ...
    // Implementar
    protected abstract void writeFileCreateParentDir(String custodyID, String relativePath, byte[] data)
            throws Exception;
