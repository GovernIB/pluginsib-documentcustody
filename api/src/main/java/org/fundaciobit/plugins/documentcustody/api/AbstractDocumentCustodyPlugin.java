 ...
 *
 */
public abstract class AbstractDocumentCustodyPlugin extends AbstractPluginProperties implements
  ...
  private final String getCustodyAnnexName2(String custodyID, String annexID)
      throws CustodyException {
    return CUSTODY_PREFIX_AND_FOLDER(custodyID) + annexID + ".ANNEX";
  }

  private final String getCustodyAnnexInfoName2(String custodyID, String annexID)
      throws CustodyException {
  ...
  protected String CUSTODY_PREFIX_AND_FOLDER(Map<String, Object> custodyParameters)
      throws CustodyException { // )
    // {
    // //
  ...
  public synchronized String reserveCustodyID(Map<String, Object> custodyParameters)
    ...
    String custodyIdEL = getProperty(getPropertyBase()
        + ABSTRACT_GENERATEUNIQUE_CUSTODYID_EXPRESSION_LANGUAGE);
  ...
  public boolean supportsDeleteCustody() {
    return this.supportsDeleteDocument() && this.supportsDeleteSignature()
        && this.supportsDeleteAnnex() && this.supportsDeleteMetadata();
  }
  ...
  public void deleteCustody(String custodyID) throws CustodyException,
    ...
    if (folder == null || folder.trim().length() == 0) {
      ...
      try {
        ...
        log.warn("Error desconegur esborrant fitxer amb path=" + path + "(custodyID="
            + custodyID + ")");
      }
    }
  }
  ...
  public String getSpecialValue(String custodyID, Map<String, Object> custodyParameters)
    ...
    String specialValue = getProperty(getPropertyBase()
        + ABSTRACT_SPECIALVALUE_EXPRESSION_LANGUAGE);
  ...
  public void saveAll(String custodyID, Map<String, Object> custodyParameters,
      DocumentCustody document, SignatureCustody signature, Metadata[] metadata)
  ...
  public void deleteDocument(String custodyID) throws CustodyException,
      NotSupportedCustodyException {
    deleteFile(custodyID, getCustodyDocumentName2(custodyID),
        getCustodyDocumentInfoName2(custodyID));
  ...
  public void deleteSignature(String custodyID) throws CustodyException,
      NotSupportedCustodyException {
    deleteFile(custodyID, getCustodySignatureName2(custodyID),
        getCustodySignatureInfoName2(custodyID));
  }
   ...
   */
  @Override
  public synchronized String addAnnex(String custodyID, AnnexCustody annex,
      Map<String, Object> custodyParameters) throws CustodyException,
      NotSupportedCustodyException {
  ...
  public void deleteAnnex(String custodyID, String annexID) throws CustodyException,
      NotSupportedCustodyException {
    deleteFile(custodyID, getCustodyAnnexName2(custodyID, annexID),
        getCustodyAnnexInfoName2(custodyID, annexID));
  ...
  protected List<Metadata> updateAutomaticMetadatas(String custodyID,
    ...
    if (supportsMetadata()) {
      ...
      List<Metadata> list = recollectAutomaticMetadatas(this, custodyParameters, propertyBase,
          ignoreErrors);
  ...
  public static List<Metadata> recollectAutomaticMetadatas(
    ...
    String itemsStr = pluginProperties.getProperty(propertyBase
        + ABSTRACT_AUTOMATIC_METADATA_ITEMS);
   ...
   * @return
   */
  protected Map<String, List<Metadata>> readMetadataInfo(String custodyID)
      throws CustodyException {
    final String path = getCustodyMetadataInfoName2(custodyID);
  ...
  protected void checkSize(String custodyID, AnnexCustody dc, String infoPath, String filePath)
    ...
    if (dc != null && dc.getLength() < 0) {
      try {
        ...
        final String msg = "No s'ha pogut actualitzar la informació de tamany del document "
            + filePath;
        log.error(msg, ex);
        throw new CustodyException(msg, ex);
      }
  ...
  protected void writeObject(String custodyID, String relativePath, Object object)
      throws CustodyException {
    try {
  ...
  protected Object readObject(String custodyID, String relativePath) throws CustodyException {
    try {
      ...
      dataStr = dataStr.replace(
          "class=\"org.fundaciobit.plugins.documentcustody.AnnexCustody\"",
          "class=\"org.fundaciobit.plugins.documentcustody.api.AnnexCustody\"");
      dataStr = dataStr.replace(
          "class=\"org.fundaciobit.plugins.documentcustody.DocumentCustody\"",
          "class=\"org.fundaciobit.plugins.documentcustody.api.DocumentCustody\"");
      dataStr = dataStr.replace(
          "class=\"org.fundaciobit.plugins.documentcustody.SignatureCustody\"",
  ...
  // Implementar
  protected abstract void writeFile(String custodyID, String relativePath, byte[] data)
      throws Exception;

  // Implementar
  protected abstract void writeFileCreateParentDir(String custodyID, String relativePath,
