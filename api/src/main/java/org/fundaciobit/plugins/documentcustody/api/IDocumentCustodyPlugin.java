...
public interface IDocumentCustodyPlugin extends IPlugin {
  ...
  public static final String DOCUMENTCUSTODY_BASE_PROPERTY = IPLUGIN_BASE_PROPERTIES
      + "documentcustody.";
   ...
   * 
   * @param proposedID
   *          Identificador proposat per la reserva
   * @param custodyParameters
   *          Parametres addicionals requerits per a la realització de la Custodia.
   * @return
   * @throws Exception
   */
   ...
   * @throws Exception
   */
  String getOriginalFileUrl(String custodyID, Map<String, Object> parameters)
   ...
   * @throws Exception
   */
  String getPrintableFileUrl(String custodyID, Map<String, Object> parameters)
      throws CustodyException;
   ...
   * @throws CustodyException
   */
  String getCsvValidationWeb(String custodyID, Map<String, Object> parameters)
      throws CustodyException;
   ...
   * @throws CustodyException
   */
  String getCsvGenerationDefinition(String custodyID, Map<String, Object> parameters)
      throws CustodyException;

  /**
   * Retorna un valor a partir de l'identificador de reserva que es pot substituir quan calgui.
   * Per defecte retornar custodyID
   * 
   * @param custodyID
   * @return
   * @throws Exception
   */
  String getSpecialValue(String custodyID, Map<String, Object> parameters)
      throws CustodyException;
   ...
   * @throws Exception
   */
  void saveAll(String custodyID, Map<String, Object> parameters, DocumentCustody document,
      SignatureCustody signatureCustody, Metadata[] metadata) throws CustodyException,
   ...
   */
  @Deprecated
  void saveDocument(String custodyID, Map<String, Object> parameters, DocumentCustody document)
  ...
  /**
   * @param custodyID
   * @return Return content of document for plain document (without attached or detached
   *         signatures) or document with attached signatures
   * @throws Exception
   */
  ...
  /**
   * Return detached sign if the document has it. For plain document (without attached or
   * detached signatures) or document with attached signatures then return null
   * 
   * @param custodyID
   * @return
   * @throws Exception
  ...
  /**
   * @return true if system automaically refresh signature or document with signature to not
   *         loss validate of signature. false Otherwise. Null if unknown.
   */
   ...
   * @throws CustodyException
   */
  String addAnnex(String custodyID, AnnexCustody annex, Map<String, Object> parameters)
      throws CustodyException, NotSupportedCustodyException;
   ...
   * @throws NotSupportedCustodyException
   */
  void deleteAnnex(String custodyID, String annexID) throws CustodyException,
   ...
   * @throws NotSupportedCustodyException
   */
  void deleteAllAnnexes(String custodyID) throws CustodyException,
      NotSupportedCustodyException;
   ...
   * @throws NotSupportedCustodyException
   */
  void addMetadata(String custodyID, Metadata metadata, Map<String, Object> parameters)
      throws CustodyException, NotSupportedCustodyException, MetadataFormatException;

  /**
   * Afegeix noves Metadades al sistema. Si les claus d'aquestes ja exeisteixen llavors
   * s'afegeix un nou valor a la clau.
   * 
   * @param custodyID
   * @param metadata
   * @throws CustodyException
  ...
  /**
   * Afegeix o actualitza una Metadada al sistema. Si no existeix l'afegeix. Si existeix i
   * nomes hi ha una instància llavors sobreescriu el valor.
   * 
   * En resum si existeix la metadada (tengui o no tengui varis valors) l'esborra i afegeix les
   * metadades
   * 
   * @param custodyID
   * @param metadata
   ...
   * @throws NotSupportedCustodyException
   */
  void updateMetadata(String custodyID, Metadata metadata, Map<String, Object> parameters)
      throws CustodyException, NotSupportedCustodyException, MetadataFormatException;

  /**
   * Afegeix o actualitza noves Metadades al sistema. Si no existeixen les afegeix. Si
   * existeixen (tengui la metadada un valor o tengui varis valors) les esborra i afegeix les
   * metadades
   * 
   * @param custodyID
   * @param metadata
   ...
   * @throws NotSupportedCustodyException
   */
  Map<String, List<Metadata>> getAllMetadata(String custodyID) throws CustodyException,
      NotSupportedCustodyException;
   ...
   * @throws NotSupportedCustodyException
   */
  List<Metadata> getMetadata(String custodyID, String key) throws CustodyException,
      NotSupportedCustodyException;
   ...
   * @throws NotSupportedCustodyException
   */
  Metadata getOnlyOneMetadata(String custodyID, String key) throws CustodyException,
      NotSupportedCustodyException;
