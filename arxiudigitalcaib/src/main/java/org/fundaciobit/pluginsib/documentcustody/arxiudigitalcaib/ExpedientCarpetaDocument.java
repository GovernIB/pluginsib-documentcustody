...
public class ExpedientCarpetaDocument {
    ...
    public static ExpedientCarpetaDocument decodeCustodyID(String custodyID) throws CustodyException {
    ...
    public String encodeCustodyID() {
        if (carpetaID == null) {
            ...
            return expedientID + SEPARATOR_EXPEDIENT_CARPETA_DOCUMENT + carpetaID + SEPARATOR_EXPEDIENT_CARPETA_DOCUMENT
                    + documentID;
        }
    }
