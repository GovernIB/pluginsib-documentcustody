package org.fundaciobit.pluginsib.documentcustody.filesystem;
...
public class TestFileSystemCustody extends TestDocumentCustody {
    ...
    public static final String propertyBase = packageBase + FileSystemDocumentCustodyPlugin.FILESYSTEM_PROPERTY_BASE;
    ...
    public void testRetro() throws Exception {
        ...
        specificProperties.setProperty(packageBase + FileSystemDocumentCustodyPlugin.FILESYSTEM_PROPERTY_BASEDIR,
    ...
    public IDocumentCustodyPlugin instantiateDocumentCustodyPlugin(Properties specificProperties)
        ...
        fsProperties.setProperty(packageBase + FileSystemDocumentCustodyPlugin.FILESYSTEM_PROPERTY_BASEDIR,
                f.getAbsolutePath());

        fsProperties.setProperty(propertyBase + AbstractDocumentCustodyPlugin.ABSTRACT_PREFIX, "cust");
    ...
    public void testUUID() throws CustodyException {
        ...
        for (int t = 0; t < 2; t++) {
            ...
            specificProperties.setProperty(
                    packageBase + FileSystemDocumentCustodyPlugin.FILESYSTEM_PROPERTY_USERANDOMUUID,
                    (t == 0 ? "true" : "false"));
