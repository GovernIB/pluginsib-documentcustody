package org.fundaciobit.pluginsib.documentcustody.alfresco.base;
...
import org.fundaciobit.pluginsib.documentcustody.alfresco.base.cmis.OpenCmisAlfrescoHelper;
...
public class AlfrescoBaseDocumentCustodyPlugin extends AbstractDocumentCustodyPlugin {
    ...
    public void deleteCustody(String custodyID) throws CustodyException, NotSupportedCustodyException {
        ...
        try {
            ...
            log.warn("Error desconegur esborrant carpeta de custodia " + realPath + "(custodyID=" + custodyID + ")");
        }
        ...
        if (folder == null || folder.trim().length() == 0) {
            ...
            try {
                ...
                log.warn("Error desconegur esborrant carpeta de cache " + path + "(custodyID=" + custodyID + ")");
            }
        }
    ...
    @Override
    protected void writeFileCreateParentDir(String custodyID, String relativePath, byte[] data) throws Exception {
