package org.fundaciobit.pluginsib.documentcustody.alfresco.base.cmis;
...
import org.fundaciobit.pluginsib.documentcustody.alfresco.base.AlfrescoBaseDocumentCustodyPlugin;
...
public class OpenCmisAlfrescoHelper {
    ...
    public String getPathCarpetaDocs(String custodyId, String path) throws Exception {
        ...
        if (site != null) {
            ...
            String p2 = alfresco
                    .getPropertyName(AlfrescoBaseDocumentCustodyPlugin.ALFRESCO_PROPERTY_BASE + "fullsitepath");
    ...
    public Folder crearCarpeta(Map<String, Object> props, String parentFolderPath, String custodyId) {
        ...
        if (parentFolderPath != null && !"".equals(parentFolderPath) && !"null".equalsIgnoreCase(parentFolderPath)) {
            ...
            try {
                ...
                Folder carpetaPadre = (Folder) getCmisSession()
                        .getObjectByPath(getPathCarpetaDocs(custodyId, parentFolderPath));
    ...
    public void borrarCarpeta(String rutaCarpeta, boolean recursiu, String custodyId) {
        ...
        try {
            ...
            log.error("La carpeta: " + rutaCarpeta
                    ...
                    for (CmisObject chidrw : childrenregWeb) {
                        ...
                        if (chidrw.getName().equals("documentLibrary")) {
                            ...
                            for (CmisObject chiddl : childrenDocsLib) {
                                ...
                                System.out
                                        .println("		- [" + chiddl.getType().getId() + "] : " + chiddl.getName());
                            }
                        }
     ...
     */
    public String crearDocument(AnnexCustody document, String fileName, String path, Map<String, Object> properties,
        ...
        if (parentFolder != null) {
            ...
            ContentStream contentStream = new ContentStreamImpl(fileName, BigInteger.valueOf(content.length), mime,
                    stream);
    ...
    public String crearDocument(AnnexCustody document, String fileName, String path, String custodyId)
            throws Exception {
    ...
    public String crearDocument(AnnexCustody document, String fileName, Map<String, Object> properties,
            String custodyId) throws Exception {

        return crearDocument(document, fileName, "", properties, custodyId);
    }

    public String crearDocument(AnnexCustody document, String fileName, String custodyId) throws Exception {
    ...
    public List<Document> getDocumentById(String id) {
        ...
        String queryString = "SELECT " + objectIdQueryName + " FROM " + type.getQueryName() + " WHERE "
                + PropertyIds.DESCRIPTION + " LIKE '" + id + "%'";
                ...
                if ("P:APBRegistro:d_anexo".equals(child.getValue())) {
                    ...
                    for (CmisExtensionElement p_child : child.getChildren()) {
                        ...
                        if (p_child.getAttributes().get("propertyDefinitionId").equals(nom)) {
                            CmisExtensionElement newExt = new CmisExtensionElementImpl(p_child.getNamespace(),
                                    p_child.getName(), p_child.getAttributes(), valor);
    ...
    public String crearDocument(byte[] data, String fileName, String path, Map<String, Object> properties,
            String custodyId) throws Exception {
        ...
        if (parentFolder != null) {
            ...
            ContentStream contentStream = new ContentStreamImpl(fileName, BigInteger.valueOf(data.length), mime,
                    stream);
        ...
        if (cmisSession2 == null) {
            ...
            if ("ATOM".equals(methodAccess)) {
                ...
                parameter.put(SessionParameter.WEBSERVICES_OBJECT_SERVICE,
                        alfresco.getAlfrescoUrl() + "/ObjectService?WSDL");
                parameter.put(SessionParameter.WEBSERVICES_POLICY_SERVICE,
                        alfresco.getAlfrescoUrl() + "/PolicyService?WSDL");
