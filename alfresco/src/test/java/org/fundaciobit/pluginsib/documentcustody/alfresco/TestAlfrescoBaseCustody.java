package org.fundaciobit.pluginsib.documentcustody.alfresco;
...
import org.fundaciobit.pluginsib.documentcustody.api.test.InfoExecutionTest;
import org.fundaciobit.pluginsib.documentcustody.api.test.Registre;
...
public class TestAlfrescoBaseCustody extends TestDocumentCustody {
    ...
    public static final String propertyBase = packageBase + AlfrescoBaseDocumentCustodyPlugin.ALFRESCO_PROPERTY_BASE;
    ...
    public IDocumentCustodyPlugin instantiateDocumentCustodyPlugin(Properties specificProperties)
        ...
        try {
            ...
            log.error("Error llegint properties des de test.properties: " + e.getMessage(), e);
            return null;
        }
        ...
        documentCustodyPlugin = (IDocumentCustodyPlugin) PluginsManager
                .instancePluginByClass(AlfrescoBaseDocumentCustodyPlugin.class, packageBase, alfrescoProperties);
    ...
    public void testRetro() throws Exception {
        ...
        for (int i = 0; i <= 2; i++) {
                ...
                case 2:
                    ...
                    for (String annexID : annexes) {
                        ...
                        if (doc.getLength() != expectedSize) {
                            Assert.fail("El tamany de l'annexe  " + doc.getName() + " no correspon amb l'esperat ("
            ...
            if (doc.getLength() != expectedSize) {
                Assert.fail("El tamany del fitxer " + doc.getName() + " no correspon amb l'esperat (" + doc.getLength()
                        + " != " + expectedSize + ")");
            }
    ...
    public void testFull() throws Exception {
        ...
        specificProperties.setProperty(packageBase + AlfrescoBaseDocumentCustodyPlugin.ALFRESCO_BASE_PATH, "/testFull");
    ...
    public void testFolderFromCustodyParameters() throws Exception {
        ...
        specificProperties.setProperty(packageBase + AlfrescoBaseDocumentCustodyPlugin.ALFRESCO_BASE_PATH,
                "/testReposWithFolder");
    ...
    public void testSimpleDoc() throws Exception {
        ...
        specificProperties.setProperty(
                getPropertyBase() + AbstractDocumentCustodyPlugin.ABSTRACT_FOLDER_EXPRESSION_LANGUAGE, folder);
        ...
        documentCustodyPlugin.saveAll(custodyID, custodyParameters, doc, null, null);
